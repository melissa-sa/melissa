...
#    URL https://github.com/zeromq/zeromq4-1/releases/download/v4.1.6/zeromq-4.1.6.tar.gz
  ...
  MESSAGE(STATUS "ZeroMQ will be installed")
    ...
    IF(ZEROMQ_FOUND)
        ...
        MESSAGE(STATUS "ZeroMQ not found. Turn on INSTALL_ZMQ to download and install from the web")
    ENDIF() 
endif(INSTALL_ZMQ)
get_filename_component(ZEROMQ_LIB_DIR ${ZEROMQ_INCLUDE_DIR} DIRECTORY)
