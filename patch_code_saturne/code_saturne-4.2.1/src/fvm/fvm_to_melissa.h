#ifndef __FVM_TO_CP_STAT_H__
#define __FVM_TO_CP_STAT_H__
 ...
 * CoProcessing stats daemon writer need to be tesselated.
 *
 * parameters:
 *   this_writer_p <-- pointer to associated writer
...
/*----------------------------------------------------------------------------
 * Write nodal mesh to a a CoProcessing stats daemon
 *
 * parameters:
 *   this_writer_p <-- pointer to associated writer.
 *   mesh          <-- pointer to nodal mesh structure that should be written.
