...
docker exec -w /home/docker/melissa -u docker $(docker ps | grep frontend | awk '{print $1}') ./install_melissa_oardocker.sh
docker exec -w /home/docker/melissa -u docker $(docker ps | grep frontend | awk '{print $1}') ./test_slurm_oardocker.sh
