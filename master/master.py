            ...
            if (pull_melissa_socket in socks.keys() and socks[pull_melissa_socket] == zmq.POLLIN):
                ...
                if (message[0] == "timeout"):
                    ...
                    if message[1] != "-1":
                        ...
                        with lock_job_state:
                            reboot_simu(simu_id, simu_job_id, global_options.batch_scheduler, global_options.workdir, output, global_options.operations)
                ...
                with lock_job_state:
                    if (simu_states[i] != job_states[i]-1):
                        if (simu_states[i] == 1 and job_states[i] == 3):
                            reboot_simu(i, simu_job_id, global_options.batch_scheduler, global_options.workdir, output, global_options.operations)
