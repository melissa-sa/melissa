...
STUDY_OPTIONS['server_timeout'] = 600               # server is restarted if no life sign for 600 seconds (int)
STUDY_OPTIONS['simulation_timeout'] = 400           # simulations are restarted if no life sign for 400 seconds (int)
STUDY_OPTIONS['checkpoint_interval'] = 300.0        # server checkpoints every 300 seconds (double)
